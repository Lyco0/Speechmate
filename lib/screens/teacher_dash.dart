...
class _TeacherDashState extends State<TeacherDash> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              phraseButton(
                "Good Morning",
                "assets/audio/phrases/good_morning.mp3",
              ),
              phraseButton(
                "How are you?",
                "assets/audio/phrases/how_are_you.mp3",
              ),
              phraseButton(
                "Keep Silent",
                "assets/audio/phrases/keep_silent.mp3",
              ),
            ],
          ),
        ),
  ...
  Widget phraseButton(String text, String audioPath) {
    return Container(
      margin: const EdgeInsets.only(bottom: 10),
      width: double.infinity,
      child: ElevatedButton(
        onPressed: () {
          audioService.playAsset(audioPath);
        },
